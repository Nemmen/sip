          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-sm text-blue-100">Your Profile</div>
                <div className="mt-2">
                  <UserAvatar 
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-6">
          {internships.map((internship: any) => (
            <Card 
              key={internship.id} 
              className="hover:shadow-xl hover:border-indigo-300 transition-all cursor-pointer group"
            ...
            >
              <CardContent className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    <div className="flex items-start gap-4">
                      ...
                      />
                      <div className="flex-1">
                        <h3 className="text-xl font-semibold text-gray-900 group-hover:text-indigo-600 transition mb-1">
                          {internship.title}
                        </h3>
                ...
                <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-4 ml-20">
                ...
                <div className="flex gap-3 ml-20">
                  ...
                  {internship._count?.applications && (
                    <span className="flex items-center gap-2 text-sm text-gray-600 px-3 py-2">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
