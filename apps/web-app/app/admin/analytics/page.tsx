...
function AdminAnalyticsContent() {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      })).sort((a: any, b: any) => b.internships - a.internships).slice(0, 5);
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <StatCard
          ...
          change={{ value: data?.users.growth || 0, isPositive: true }}
        />
        <StatCard
          ...
          change={{ value: data?.internships.growth || 0, isPositive: true }}
        />
        <StatCard
          ...
          change={{ value: data?.applications.growth || 0, isPositive: true }}
        />
        <StatCard
