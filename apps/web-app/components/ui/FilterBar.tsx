    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4">
      <div className="flex flex-wrap items-center gap-4">
            ...
            return (
              <div key={index} className="flex items-center gap-2">
                ...
                <input
                  ...
                  value={filter.value}
                  onChange={(e) => handleChange(filter, e.target.value)}
                  className="px-3 py-1.5 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-40"
                />
              </div>
            );
          }
            ...
            return (
              <div key={index} className="flex items-center gap-2">
                ...
                <input
                  ...
                  value={filter.value}
                  onChange={(e) => handleChange(filter, e.target.value)}
                  className="px-3 py-1.5 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-32"
                />
              </div>
            );
          }
        ...
        {hasActiveFilters && onReset && (
          <button
            onClick={onReset}
            className="ml-auto px-3 py-1.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md transition"
          >
            Reset Filters
          </button>
        )}
